...
dirname = "/home/youssef/Documenten/Projectcomputervisie/testImages/minerva/query_paintings_20/"
f = "20190203_110825.jpg"
def test():
    ...
    for possiblePainting in possiblePaintings:
        ...
        if des is not None:
            ...
            result = cv.drawMatchesKnn(img1,kp,img2,kp2,filteredHighestScores[0][1][2],None)
            rows, cols, ch = result.shape
            result= cv.resize(result,(cols//2,rows//2))
